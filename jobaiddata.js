window.JAData = (function () {
    var stmts = [],
        ...
        peeps = [
            {"name":"bob", "account":{"homePage":"http://cloud.scorm.com","name":"bob"}},
            {"name":"mary", "account":{"homePage":"http://cloud.scorm.com","name":"mary"}},
            {"name":"vince", "account":{"homePage":"http://cloud.scorm.com","name":"vince"}},
            {"name":"alice", "account":{"homePage":"http://cloud.scorm.com","name":"alice"}},
            {"name":"nick", "account":{"homePage":"http://cloud.scorm.com","name":"nick"}},
            {"name":"hershel", "account":{"homePage":"http://cloud.scorm.com","name":"hershel"}},
            {"name":"roy", "account":{"homePage":"http://cloud.scorm.com","name":"roy"}},
            {"name":"alex", "account":{"homePage":"http://cloud.scorm.com","name":"alex"}},
            {"name":"camille", "account":{"homePage":"http://cloud.scorm.com","name":"camile"}},
            {"name":"sasha", "account":{"homePage":"http://cloud.scorm.com","name":"sasha"}},
            {"name":"chad", "account":{"homePage":"http://cloud.scorm.com","name":"chad"}},
            {"name":"thomas", "account":{"homePage":"http://cloud.scorm.com","name":"thomas"}},
            {"name":"michael", "account":{"homePage":"http://cloud.scorm.com","name":"michael"}},
            {"name":"violet", "account":{"homePage":"http://cloud.scorm.com","name":"violet"}},
            {"name":"owen", "account":{"homePage":"http://cloud.scorm.com","name":"owen"}},
            {"name":"george", "account":{"homePage":"http://cloud.scorm.com","name":"george"}},
            {"name":"persephone", "account":{"homePage":"http://cloud.scorm.com","name":"persephone"}},
